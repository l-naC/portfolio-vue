<template>
    <div class="w-screen sm:h-auto md:h-screen lg:h-screen flex items-center justify-evenly p-5 flex-col sm:flex-col md:flex-row lg:flex-row" id="section-about">
        <div class="w-full sm:w-full md:w-1/2 lg:w-1/2" id="text-about">
            ...
            <p>En mai 2021, j’ai décidé de devenir développeur web freelance après un poste en tant que développeur full-stack dans une startup puis 2 ans à Prisma Media en tant que Product owner junior. </p>
