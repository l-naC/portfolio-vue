  ...
  <nav class="h-screen float-right z-50 fixed text-red-800 right-0">
    <ul class="h-full flex flex-col justify-center align-center">
      ...
      v-on:mouseleave="mouseleave('H')">
          <a href="#view"><p :class="styleOpacityH">Home</p><div class="nav-round" :class="styleRoundH"></div></a></li>
      <li 
      v-on:mouseover="mouseover('A')"
      v-on:mouseleave="mouseleave('A')">
        <a href="#section-about"><p :class="styleOpacityA">About</p><div class="nav-round" :class="styleRoundA"></div></a></li>
      <li 
      v-on:mouseover="mouseover('S')"
      v-on:mouseleave="mouseleave('S')">
        <a href="#section-skills"><p :class="styleOpacityS">Skills</p><div class="nav-round" :class="styleRoundS"></div></a></li>
      <li 
      v-on:mouseover="mouseover('P')"
      v-on:mouseleave="mouseleave('P')">
        <a href="#section-projects"><p :class="styleOpacityP">Projects</p><div class="nav-round" :class="styleRoundP"></div></a></li>
      <li 
      v-on:mouseover="mouseover('C')"
      v-on:mouseleave="mouseleave('C')">
        <a href="#section-contact"><p :class="styleOpacityC">Contact</p><div class="nav-round" :class="styleRoundC"></div></a></li>
    </ul>
  </nav>
</template>
...
.nav-round{
  @apply rounded-full bg-redjapan mx-3 my-2 transition ease-out duration-700
}
